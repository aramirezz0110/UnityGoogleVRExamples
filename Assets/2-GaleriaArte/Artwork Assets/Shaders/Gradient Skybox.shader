...
Shader "Unity Devs/Gradient Skybox"
{
    Properties
    {
        _Color1 ("Top Color", Color) = (1, 1, 1, 1)
        _Exponent1 ("Top Intensity", Range (-10, 10)) = 1.0
        _Color2 ("Middle Color", Color) = (1, 1, 1, 1)
        _Intensity ("Middle Intensity", Range (-10, 10)) = 1.0
        _Color3 ("Bottom Color", Color) = (1, 1, 1, 1)
        _Exponent2 ("Bottom Intensity", Range (-10, 10)) = 1.0
    }
